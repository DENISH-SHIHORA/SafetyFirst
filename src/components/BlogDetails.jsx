    ...
    <div className="container py-5">
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="mb-5">
            ...
            <p>
              ...
              nonumy, gubergren sit stet no diam kasd vero, eos tempor gubergren
              clita est consetetur dolores et dolor. Sadipscing lorem kasd
              labore ea sanctus sanctus, dolores invidunt et consetetur et duo.
              Tempor dolores accusam sit vero sit, sed labore duo vero et at, et
              amet et justo gubergren. Labore aliquyam voluptua dolor nonumy
              lorem. Sanctus sed sadipscing rebum ipsum dolor et ea no. Ipsum
              elitr sea erat.
            </p>
            <p>
              ...
              sit. Dolor erat justo dolore sit invidunt, sed duo dolor et amet
              no et. Ut takimata tempor kasd amet kasd ut. No et ipsum amet
              tempor et. Sed nonumy sed vero ut, sed aliquyam accusam clita
              dolores tempor est. Ea et takimata consetetur et amet sanctus. Duo
              no diam ipsum diam dolores, eirmod diam dolores clita sed erat
              magna. Dolore ut amet ea magna. Sea et dolore sit labore at amet
              eos. Dolor voluptua sit rebum sit ut nonumy. Dolor amet amet sit
              sadipscing, lorem.
            </p>
            <h2 className="mb-4">Est dolor lorem et ea</h2>
            <img
              className="img-thumbnail p-3 w-50 float-left mr-4 mb-3"
              src="img/blog-1.jpg"
              alt="Image"
            />
            <p>
            ...
            <img
              className="img-thumbnail p-3 w-50 float-right ml-4 mb-3"
              src="img/blog-2.jpg"
              alt="Image"
            />
            <p>
          ...
          <div className="media bg-primary text-white mb-5 p-4 p-md-5">
            <img
              src="img/user.jpg"
              alt="Image"
              className="img-thumbnail p-3 mr-4 mt-1 bg-primary"
              style={{ width: 100 }}
            />
            <div className="media-body">
              <h5 className="mb-3">John Doe</h5>
              <p className="m-0">
                Conset elitr erat vero sanctus labore dolor ipsum et diam,
                tempor dolores eos dolor conset lorem ipsum, ipsum accusam ipsum
                sit no ut est. Guber ea ipsum erat conset magna kasd amet est
                magna elitr ea sit justo sed sanctus.
              </p>
            </div>
          </div>
          <div className="mb-5">
            ...
            <div className="media mb-4">
              <img
                src="img/user.jpg"
                alt="Image"
                className="img-thumbnail p-2 mr-3 mt-1"
                style={{ width: 60 }}
              />
              <div className="media-body">
                <h6>
        ...
        <div className="col-lg-4 mt-5 mt-lg-0">
          ...
          <div className="mb-5">
            <img src="img/blog-1.jpg" alt className="img-thumbnail p-3" />
          </div>
          <div className="mb-5">
          ...
          <div className="mb-5">
            <img src="img/blog-2.jpg" alt className="img-thumbnail p-3" />
          </div>
          <div className="mb-5">
          ...
          <div className="mb-5">
            <img src="img/blog-3.jpg" alt className="img-thumbnail p-3" />
          </div>
          <div>
            <h4 className="mb-4">Plain Text</h4>
            Aliquyam sed lorem gubergren stet diam dolor sed ut sit. Ut sanctus
            erat ea est invidunt aliquyam dolor et. Et no consetetur eos labore
            ea erat voluptua et. Et aliquyam dolore sed erat. Magna sanctus sed
